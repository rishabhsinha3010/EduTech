<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "Select * from student_ls where Username='$username' AND Password='$password'";
        ...
        if ($num == 1){
          ...
          header("location: http://localhost/web/Student_profile.php");
          // echo "success!";
        }
        else{
        ...
        <div class="content">
          <form action="Student_login.php" method="POST" >
              ...
              <br>
                ...
                <button id="SignUp" type="submit" value="SignUp"> <a href="Student_signup.php" style="color: rgba(64, 75, 165, 1);"> SignUp </a></button>
            </form>
        </div>
      </div> 
    </div>
